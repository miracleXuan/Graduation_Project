...
namespace RTSEngine
{
	public class TaskUI : MonoBehaviour {
		...
		public TaskManager.TaskTypes TaskType; //the task's type goes here.//任务的类型在这里 

        //For multiple selection icons, we use the same script:对于多选图标，我们使用相同的脚本： 
        public Image EmptyBar;
        public Image FullBar;

        [HideInInspector]
        public TaskLauncher TaskComp; //The task launcher connected to this task, if there's one.//The task launcher connected to this task, if there's one.
