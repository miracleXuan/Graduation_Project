...
namespace RTSEngine.NPC
{
    public abstract class NPCComponentBase : MonoBehaviour, INPCComponent
    {
        ...
        // WIP
        [HideInInspector, SerializeField, Tooltip("Enable logging to record logs of the events taken by this NPC component which will be logged in the 'Event Logs' field in the inspector.")]
